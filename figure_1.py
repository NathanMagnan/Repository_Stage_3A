...
ALF_parameters = [1.5, 0.5, 1.3, 0.3, 0.01]
...
subplot1 = plt.subplot2grid((11, 11),(0, 0), rowspan = 3, colspan = 3) # Illustris 2D plot
subplot2 = plt.subplot2grid((11, 11),(0, 4), rowspan = 3, colspan = 3) # ALF 2D plot
subplot3 = plt.subplot2grid((11, 11),(0, 8), rowspan = 3, colspan = 3) # Illustris and ALF 2PCFs
subplot4 = plt.subplot2grid((11, 11),(4, 0), rowspan = 7, colspan = 11) # Illustris and ALF MST histograms
