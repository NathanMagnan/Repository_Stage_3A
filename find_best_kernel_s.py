...
for i in range(n_groups):
   ...
   List_groups.append((X_s_data_a, Y_s_data_a, X_s_test_a, Y_s_test_a))
...
for i in range(len(Kernel_names)):
    print("Covariance matrix for statistic s and kernel " + Kernel_names[i] + " :")
...
plt.title("$k$-fold cross validation : $s$")
