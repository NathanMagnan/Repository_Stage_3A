...
np.savetxt(str(target) + "_X_d", ab.MST_histogram['x_d'])
np.savetxt(str(target) + "_Y_d", ab.MST_histogram['y_d'])
np.savetxt(str(target) + "_X_l", ab.MST_histogram['x_l'])
np.savetxt(str(target) + "_Y_l", ab.MST_histogram['y_l'])
np.savetxt(str(target) + "_X_b", ab.MST_histogram['x_b'])
np.savetxt(str(target) + "_Y_b", ab.MST_histogram['y_b'])
np.savetxt(str(target) + "_X_s", ab.MST_histogram['x_s'])
np.savetxt(str(target) + "_Y_s", ab.MST_histogram['y_s'])
...
density = np.shape(X_masked)[0] / (720**3)
print(density)
