...
for i in range(n_groups):
   ...
   List_groups.append((X_b_data_a, Y_b_data_a, X_b_test_a, Y_b_test_a))
...
for i in range(len(Kernel_names)):
    print("Covariance matrix for statistic b and kernel " + Kernel_names[i] + " :")
...
plt.title("$k$-fold cross validation : $b$")
